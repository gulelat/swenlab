<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportsPage.aspx.cs" Inherits="SwenUI.ReportsPage" %>
...
<body style="background-color: #66FFFF">
    ...
    <div>
        ...
        <br />
        Search Guest in Room:
        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
        <asp:Button ID="Button1" runat="server" Text="Search" />
        <br />
        <asp:GridView ID="GridView1" runat="server">
            <Columns>
                <asp:BoundField HeaderText="Room Number" ReadOnly="True" />
                <asp:BoundField HeaderText="Guest Name" />
                <asp:BoundField HeaderText="Number of Adult Guests" />
                <asp:BoundField HeaderText="Number of Children Guest" />
                <asp:BoundField HeaderText="Room Status" />
            </Columns>
        </asp:GridView>
        <br />
        Search All Guest in All Room:<br />
        <asp:GridView ID="GridView2" runat="server">
            <Columns>
                ...
                <asp:BoundField HeaderText="Guest Name" />
                <asp:BoundField HeaderText="Number of Adult Guests" />
                <asp:BoundField HeaderText="Number of Children Guests" />
                <asp:BoundField HeaderText="Room Status" />
            </Columns>
        </asp:GridView>
        <br />
        <asp:Button ID="Button2" runat="server" Text="Return to Home Page" />
        <br />
