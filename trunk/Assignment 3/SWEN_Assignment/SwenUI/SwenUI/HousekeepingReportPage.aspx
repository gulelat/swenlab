<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HousekeepingReportPage.aspx.cs" Inherits="SwenUI.HousekeepingReportPage" %>
...
<body style="background-color: #66FFFF">
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            <Columns>
                <asp:BoundField HeaderText="Staff Number" />
                <asp:BoundField HeaderText="Staff Name" />
                <asp:BoundField HeaderText="Duty Type" />
            </Columns>
        </asp:GridView>
        <br />
        <br />
